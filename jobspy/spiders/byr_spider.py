...
class ByrSpider(scrapy.Spider):
    ...
    start_urls = [
        "http://m.byr.cn/board/ParttimeJob/6?p=1",
        "http://m.byr.cn/board/ParttimeJob/6?p=2",
        "http://m.byr.cn/board/ParttimeJob/6?p=3",
        "http://m.byr.cn/board/ParttimeJob/6?p=4",
        "http://m.byr.cn/board/ParttimeJob/6?p=5",
    ]
